 ...
 * @author skipper
 */
public class IndividualReportStepTwoJPanel extends javax.swing.JPanel {

    /**
     * Creates new form IndividualReportStepTwoJPanel
     */
    ...
    public IndividualReportStepTwoJPanel(JPanel container,UserAccount userAccount,Organization organization,
            Enterprise enterprise,Enterprise selectHospital,HealthSystem system,
            BasicInfo basic,PatientInfo patient,ProductInfo products) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Report: Step 3: Confirmation");
    ...
    private void confirmJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_confirmJButtonActionPerformed
        ...
        Network city = selectHospital.findNetwork(system, selectHospital).get(2);
        ...
        if(validationTeam!=null){
            ...
            JOptionPane.showMessageDialog(null, "The PSO in the city doesn't exist.");
            return;
        }
